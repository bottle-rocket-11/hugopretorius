...
- Implemented a front-end interface 
  - Deployed to the University 
- Created a data analytics 
  - Currently used 
- Created target 
...
* Designed curriculum
* Received _Excellence in Teaching_ aw
...
- Developed a cohesive learning communit
- Managed 
- Organized events to prom
